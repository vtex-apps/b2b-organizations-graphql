// necessary data to check if a user is part of buyer org on MasterData
const PAGINATION = {
  page: 1,
  pageSize: 50,
}
...
// This was copied (slightly modified) from storefront-permissions to avoid
// a call to other application just to check if the user is part of a buyer org.
